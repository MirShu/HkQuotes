...
public class MeCollectionActivity extends Activity {
    ...
    private void bindRecycleView() {
        this.myOrderReycAdapter = new RecyclerAdapter<NewsModel>(MeCollectionActivity.this, myOrderReycList,
                R.layout.item_news) {
            @Override
        ...
        this.recyclerView.setLayoutManager(new GridLayoutManager(MeCollectionActivity.this, 1,
        ...
        this.myOrderReycAdapter.setOnItemClickListener((parent, position) -> {
            ...
            UIHelper.startActivity(MeCollectionActivity.this, NewsDetailActivity.class, bundle);
