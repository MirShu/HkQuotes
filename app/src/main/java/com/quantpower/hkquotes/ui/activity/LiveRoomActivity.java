...
import com.quantpower.hkquotes.model.LiveRoomModel;
import com.quantpower.hkquotes.utils.BaseActivity;
import com.quantpower.hkquotes.utils.UIHelper;
import com.quantpower.hkquotes.utils.URLS;
import com.quantpower.hkquotes.widget.MNViderPlayer;
...
//        setContentView(R.layout.collectionactivity);
        setContentView(R.layout.activitty_live_room);
...
//        this.rl_head = (RelativeLayout) findViewById(R.id.rl_head1);
        ...
        tvCurriculum = (TextView) findViewById(R.id.tv_curriculum);
        imageBack.setOnClickListener(v -> finish());
        tvCurriculum.setOnClickListener(v -> UIHelper.startActivity(LiveRoomActivity.this, CurriculumActivity.class));
        //获取屏幕的宽高
