...
import com.quantpower.hkquotes.utils.PrefUtils;
...
public class NewsDetailActivity extends Activity implements View.OnClickListener,
    ...
    public void initView() {
        ...
        collectionChec.setOnClickListener(v -> {
            if (collectionChec.isChecked()) {
                UIHelper.toastMessage(NewsDetailActivity.this, "已收藏");
            } else {
                UIHelper.toastMessage(NewsDetailActivity.this, "已取消收藏");
            }
        });
